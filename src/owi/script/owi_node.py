...
class Panel():
    ...
    def __init__(cls):
        ...
        rospy.Subscriber("state", owi.msg.joint_state, cls.report)
        rospy.Subscriber("/move_group/fake_controller_joint_states", JointState,cls.execute)
        ...
        cls.button.clicked.connect(cls.clicked)
        window.show()
        sys.exit(app.exec_())

    @classmethod
    def clicked(cls, value):
